...
library SVGGeneratorV2 {
        ...
        returns (string memory)
    {
        ...
        return string.concat(
            ...
            '<g fill="url(#a)" font-size="5" font-family="AuxMono"><text x="43.5" y="5.5" letter-spacing="-.38" dominant-baseline="middle" text-anchor="middle" transform="translate(19 140)">',
            addrPart1,
            '</text><text x="43.5" y="10.5" letter-spacing="-.38" dominant-baseline="middle" transform="translate(-20 140)">',
            addrPart2,
            "</text></g>",
            ops,
            sps,

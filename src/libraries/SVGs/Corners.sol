...
library Corners {
    ...
    function getCorner(uint256 id) external pure returns (string memory, string memory) {
        string[7] memory svgs = [
            '<path d="M6 6h6v6H6zm82 0h6v6h-6zM6 88h6v6H6zm82 0h6v6h-6z" class="r"/>',
